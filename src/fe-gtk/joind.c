...
joind_show_dialog (server *serv)
{
	...
	image1 = gtk_image_new_from_icon_name ("network-workgroup", GTK_ICON_SIZE_LARGE_TOOLBAR);
	...
	okbutton1 = gtk_button_new_from_icon_name ("dialog-ok", GTK_ICON_SIZE_BUTTON);
